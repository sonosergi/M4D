...
PostRouter.get('/getPost', (req, res) => PostController.getPost(req, res));
...
PostRouter.put('/updateLikes', (req, res) => PostController.updateLikes(req, res));

PostRouter.post('/addComment', (req, res) => PostController.addComment(req, res));
