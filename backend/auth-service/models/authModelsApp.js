...
export class AuthModel {
  ...
  static async createUser(type, phoneNumber, username, password, email) {
    ...
    await AuthDatabase.createUser(uniqueId, type, phoneNumber, username, hashedPassword, email, verificationCode);
  }
