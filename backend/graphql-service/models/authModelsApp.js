...
export class AuthModel {
  ...
  static async createUser(type, phoneNumber, username, password) {
    ...
    await AuthDatabase.createUser(uniqueId, type, phoneNumber, username, hashedPassword, verificationCode);
  }
