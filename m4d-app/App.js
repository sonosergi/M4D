...
// Configura los clientes Apollo
const clientNoAuth = new ApolloClient({
  uri: 'http://192.168.1.49:7575/graphql/noAuth',
  credentials: 'include',
  cache: new InMemoryCache()
});

const clientWithAuth = new ApolloClient({
  uri: 'http://192.168.1.49:7575/graphql/withAuth',
  credentials: 'include',
  cache: new InMemoryCache()
});
...
export default function App() {
  ...
  return (
    <ApolloProvider client={isAuthenticated ? clientWithAuth : clientNoAuth}>
      <NavigationContainer 
        ref={navigationRef} 
